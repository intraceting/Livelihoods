...
#   Author: RLEDOG <i@rledog.com>                                       #
#   Intro:  https://www.rledog.com/                                        #
#=======================================================================#
cur_dir=`pwd`
...
download_file(){
    local download_root_url="https://cdn.pcnjdy.com/files"
...
preinstall_l2tp(){
    ...
    read -p "(Default PSK: rledog.com):" mypsk
    [ -z ${mypsk} ] && mypsk="rledog.com"
...
EOF
    ...
    echo "# Intro: http://www.rledog.com/                                 #"
    echo "# Author: RLEDOG <i@rledog.com>                               #"
    echo "###############################################################"
